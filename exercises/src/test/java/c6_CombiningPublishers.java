...
public class c6_CombiningPublishers extends CombiningPublishersBase {
    ...
    public void mail_box_switcher() {
        ...
        Flux<Message> myMail = mailBoxPrimary().switchOnFirst((message, primaryMailbox) -> {
            if (message.get().metaData.contains("spam")) {
    ...
    public void acid_durability() {
        ...
        Flux<String> committedTasksIds = tasksToExecute()
                .concatMap(task -> task.flatMap(value -> commitTask(value).thenReturn(value)));
    ...
    public void car_factory() {
        ...
        carEngineProducer(), (chassis, engine) -> new Car(chassis, engine));
